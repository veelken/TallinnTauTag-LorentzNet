#ifndef TallinnTauTag_LorentzNet_PFRecoTauDiscriminationByLorentzNet_h
#define TallinnTauTag_LorentzNet_PFRecoTauDiscriminationByLorentzNet_h
...
namespace reco 
{
  namespace tau 
  {
    class PFRecoTauDiscriminationByLorentzNet : public edm::stream::EDProducer<edm::GlobalCache<cms::Ort::ONNXRuntime>>
    {
     public:
      explicit PFRecoTauDiscriminationByLorentzNet(const edm::ParameterSet& cfg, const cms::Ort::ONNXRuntime* cache);
      ~PFRecoTauDiscriminationByLorentzNet() override;
